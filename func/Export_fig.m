...
nondisable_average_path = 'C:\abe_backup\backup\01_修士\06_Xsens_analysis\01_Xsens_Data\able_bodied\健常者歩容特性平均.xlsx';
...
fprintf('the num of footcontact: %d\n', length(Rcontact_frame));
fprintf('(After validation) the num of footcontact: %d\n', length(valid_Rcontact_frame));
...
nondisabled_data = 'C:\abe_backup\backup\01_修士\06_Xsens_analysis\01_Xsens_Data\able_bodied\健常者平均および標準誤差用角度データ.xlsx';
